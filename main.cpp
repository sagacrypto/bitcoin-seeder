...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "sagacoin-seeder\n"
...
static const string mainnet_seeds[] = {"node1.sagacoin.net", "node2.sagacoin.net", "node3.sagacoin.net", "node4.sagacoin.net", "node5.sagacoin.net", "node6.sagacoin.net", ""};
static const string testnet_seeds[] = {"testnode1.sagacoin.net", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd4.onion", 48744), true);
  }
  do {
